...
using PlataformaDeEducacaoOnline.Financeiro.Data.Extensions;

namespace PlataformaDeEducacaoOnline.Financeiro.Data.Context;

public class FinanceiroContext(DbContextOptions<FinanceiroContext> options, IMediator mediator) : DbContext(options), IUnitOfWork
{
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(FinanceiroContext).Assembly);
