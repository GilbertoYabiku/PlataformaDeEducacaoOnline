                                ...
                                IOptions<JwtSettings> jwtSettings) : MainController(notificacoes, mediator, identityUser)
{
    ...
    public async Task<ActionResult> RegistrarAluno(RegisterUser registerUser)
    {
    ...
    public async Task<ActionResult> RegistrarAdmin(RegisterUser registerUser)
    {
        if (!ModelState.IsValid)
        {
            NotificarErro(ModelState);
    ...
    private async Task<(IdentityUser User, IdentityResult Result)> RegistrarUsuario(RegisterUser registerUser, string role)
    {
    ...
    private async Task<LoginResponse> GerarToken(string email)
    {
    ...
    private LoginResponse ObterRespostaToken(IdentityUser user, IList<Claim> claims, string encodedToken)
    {
