...
namespace PlataformaDeEducacaoOnline.Tests.Conteudos.Application;
...
public class AulaTests
{
    ...
    public void ConcluirAula_ProgressoEncontrado_DeveExecutarComSucesso()
    {
        ...
        // Assert
        Assert.True(progressoAula.Status == EnumAulaStatus.Concluida);
    }
    ...
    public void AdicionarProgresso_NovoProgresso_DeveAssociarAulaComSucesso()
    {
        ...
        // Assert
        Assert.True(progressoAula.Status == EnumAulaStatus.EmAndamento);
    }
}